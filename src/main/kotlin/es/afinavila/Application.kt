...
import es.afinavila.services.ComunidadNames
...
fun main() {
    ...
    val namesPath = System.getenv("COMUNIDAD_NAMES_PATH") ?: "/data/comunidad_names.json"

    ArchivoService.filesPath = filesPath
    ComunidadNames.setConfigPath(namesPath)
